...
|:----:|:----:|
| MC 1.15.* | Use [0.96.1.10](https://github.com/TownyAdvanced/Towny/releases/tag/0.96.1.0) or the above Latest Pre-Release. |
| MC 1.14.* | [0.96.1.10](https://github.com/TownyAdvanced/Towny/releases/tag/0.96.1.0) |
| MC 1.13.2 | [0.96.1.10 for 1.13.2](https://github.com/TownyAdvanced/Towny/releases/tag/0.96.1.0for1.13.2) |
